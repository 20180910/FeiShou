...
public class CompleteOrderFragment extends BaseFragment implements LoadMoreAdapter.OnLoadMoreListener{
    ...
    protected void initView() {
        adapter=new CompleteOrderAdapter(mContext,R.layout.item_complete_order,pageSize);
